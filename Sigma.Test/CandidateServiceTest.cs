...
namespace Sigma.Test
{
    public class CandidateServiceTest
    {
        ...
        [Test]
        public async Task CreateOrUpdateCandidateAsync_ShouldAddNewCandidate_WhenNotExist()
        {
            // Arrange
        ...
        [Test]
        public async Task CreateOrUpdateCandidateAsync_ShouldCreateNewCandidate_WhenValidModel()
        {
            ...
            _mockCandidateRepository
                ...
                //.ReturnsAsync(new Candidate { Id = 1, Email = candidateDto.Email }); // Returning a new candidate object with an Id
            ...
            ClassicAssert.IsNotNull(result);  // Assert that the result is not null
